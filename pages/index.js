    ...
    <ProfileRelationsBoxWrapper>
      ...
      <ul>
        {/*propriedades.items.map((itemAtual) => {
          return (
            <li key={itemAtual.items.githubUser}>
              <a href={`/users/${itemAtual.githubUser}`} key={itemAtual.githubUser}>
                <img src={`https://github.com/${itemAtual.githubUser}.png`} />
                <span>{itemAtual}</span>
              </a>
            </li>
          )
